...
export default function HeroBanner({ items, onPlay }) {
    ...
    <div className="relative h-[420px] w-full overflow-hidden mb-8">
      ...
      <div className="relative h-full flex flex-col justify-end px-6 pb-10 max-w-2xl">
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="flex items-center gap-2 px-6 py-2.5 rounded-lg bg-vault-card/80 hover:bg-vault-card text-vault-text font-medium text-sm transition-all border border-vault-border">
